...
class CircuitEllipse(Circuit):
    ...
    def draw(self):
        ...
        pygame.draw.ellipse(self.surface, self.color_wall, 
                            (self.center_draw[0] - self.outter[0], self.center_draw[1] - self.outter[1],
        ...
        pygame.draw.ellipse(self.surface, self.color_background,
                            (self.center_draw[0] - self.outter[0] + self.slow_area + self.wall, self.center_draw[1] - self.outter[1] + self.slow_area + self.wall, 
        ...
        pygame.draw.ellipse(self.surface, self.color_wall,
                            (self.center_draw[0] - self.inner[0], self.center_draw[1] - self.inner[1],
                            2 * self.inner[0], 2 * self.inner[1]))
        pygame.draw.ellipse(self.surface, self.color_background,
                            (self.center_draw[0] - self.inner[0] + self.wall, self.center_draw[1] - self.inner[1] + self.wall,
